...
public class GuessMyNumberV1
{
    public static void main(String[] args)
    {
        ...
        int secretNumber = (int)(Math.random() * (upperLimit - lowerLimit)) + lowerLimit + 1;
        ...
        while(userGuess != secretNumber)
        {
            ...
            {
                System.out.print("Guess number " + (counter+1) + " is too LOW. ");
            }
            else if (userGuess > secretNumber)
            {
                System.out.print("Guess number " + (counter+1) + " is too HIGH. ");
            }
